...
// 导入抠出来的js文件
// require写的是文件路径
var encrypt = require('./match14_get_m');
...
app.post('/encrypt', function (req, res){
    ...
    var item = req.body;
    var timestamp_a = item.timestamp_a,
        timestamp_b = item.timestamp_b,
        click_time = item.click_time,
        v14 = item.v14,
        v142 = item.v142;

    // 调用解析函数
    var encryptData = encrypt.sp(timestamp_a, timestamp_b, click_time, v14, v142);
